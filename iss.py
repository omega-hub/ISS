...
cam.setPitchYawRoll(Vector3(3.1, 0, 0.0))
...
setNearFarZ(1, 100000000) # was 1, 100000000
...
earth.addChild(atmo)
atmo.setEffect('./atmosphere -e #9090f030 -a -t -D')

#starfield.loadStars(earth, "data/hyparcusxyz_all.csv")
starfield.loadStars(earth, "data/hyparcusxyz_small.csv")
